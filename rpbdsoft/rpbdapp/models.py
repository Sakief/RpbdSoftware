...
class Profile(models.Model):
    ...
    owner_name = models.CharField(verbose_name="Owner Name", max_length=70)
    holding_no = models.CharField(verbose_name="Holding No", max_length=10)
    road_name = models.CharField(verbose_name="Road Name/No", max_length=10)
    block_no = models.CharField(verbose_name="Block No", max_length=10)
    village = models.CharField(verbose_name="Village/Ward", max_length=20)
    union = models.CharField(verbose_name="Union", max_length=20)
    ...
    respondent_designation = models.CharField(
        verbose_name="Respondent Designation", max_length=30
    )
    contact_no1 = models.CharField(verbose_name="Contact No 1", max_length=11)
    contact_no2 = models.CharField(verbose_name="Contact No 2", max_length=11)
    contact_no3 = models.CharField(verbose_name="Contact No 3", max_length=11)
    total_staff = models.IntegerField(verbose_name="Total Staff")
    outlet_landmark = models.CharField(verbose_name="Outlet Landmark", max_length=30)
    gps_lat = models.DecimalField(
        verbose_name="GPS Lattitude", max_digits=9, decimal_places=6
    )
    gps_long = models.DecimalField(
        verbose_name="GPS Longitude", max_digits=9, decimal_places=6
    )
    ...
    entry_by = models.CharField(verbose_name="Entry By", max_length=50)
